        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            ...
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items" name="orderby" id="orderby">
              <option class="text-center" value="-1" {{ $order==-1 ? "selected" :""}}>Sort By Default ↲</option>
              <option class="text-center" value="1" {{ $order==1 ? "selected" : "" }}>Date, New To Old</option>
              <option class="text-center" value="2" {{ $order==2 ? "selected" : "" }}>Date, Old To New</option>
              <option class="text-center" value="3" {{ $order==3 ? "selected" : "" }}>Price, Low To High</option>
              <option class="text-center" value="4" {{ $order==4 ? "selected" : "" }}>Price, High To Low</option>
            </select>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                  ...
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        @foreach (explode(",",$product->images) as $galleryImg)
                         <a href="{{ route('shop.product.details',['product_slug'=>$product->slug]) }}"><img loading="lazy" src="{{ asset('uploads/products') }}/{{ $galleryImg }}" width="330" height="400" alt="{{ $product->name }}" class="pc__img"></a>
                        @endforeach
                    </div>
                  </div>
              ...
              <div class="pc__info position-relative">
                ...
                <form method="POST" action="{{ route('wishlist.item.remove',['rowId'=>Cart::instance('wishlist')->content()->where('id',$product->id)->first()->rowId]) }}">
                  @csrf
                  @method("DELETE")
                  <button type="submit" class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist filled-heard " title="Remove For Wishlist">
