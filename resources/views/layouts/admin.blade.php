                    ...
                    <div class="section-menu-left"> 
                        <div class="box-logo">
                            <a href="{{ route('admin.index') }}" id="site-logo-inner">
                                {{-- <img class="" alt="" src="{{ asset('admin_assets/images/logo/logo.png') }}" --}}
                                <img class="" alt="" src="{{ asset('admin_assets/images/logo/logo.png') }}"
                                ...
                                <div class="header-left">
                                    <a href="index-2.html">
                                        <img class="" id="logo_header_mobile" alt="" src="{{ asset('admin_assets/images/logo/logo.png') }}"
                                            data-light="images/logo/logo.png" data-dark="{{ asset('admin_assets/images/logo/logo.png') }}"
                                            ...
                                            <ul class="mb-24">
                                                ...
                                                <li>
                                                    <ul>
                                                        ...
                                                        <li class="product-item gap14 mb-10">
                                                            <div class="image no-bg">
                                                                <img src="{{ asset('admin_assets/images/products/18.png') }}" alt="">
                                                            </div>
                                                            <div class="flex items-center justify-between gap20 flex-grow">
                                                                <div class="name">
                                                        ...
                                                        <li class="product-item gap14">
                                                            <div class="image no-bg">
                                                                <img src="{{ asset('admin_assets/images/products/19.png') }}" alt="">
                                                            </div>
                                                            <div class="flex items-center justify-between gap20 flex-grow">
                                                                <div class="name">
                                            ...
                                            <ul class="">
                                                ...
                                                <li>
                                                    <ul>
                                                        <li class="product-item gap14 mb-10">
                                                            <div class="image no-bg">
                                                                <img src="{{ asset('admin_assets/images/products/20.png') }}" alt="">
                                                            </div>
                                                            <div class="flex items-center justify-between gap20 flex-grow">
                                                                <div class="name">
                                                        ...
                                                        <li class="product-item gap14 mb-10">
                                                            <div class="image no-bg">
                                                                <img src="{{ asset('admin_assets/images/products/21.png') }}" alt="">
                                                            </div>
                                                            <div class="flex items-center justify-between gap20 flex-grow">
                                                                <div class="name">
                                                        ...
                                                        <li class="product-item gap14 mb-10">
                                                            <div class="image no-bg">
                                                                <img src="{{ asset('admin_assets/images/products/22.png') }}" alt="">
                                                            </div>
                                                            <div class="flex items-center justify-between gap20 flex-grow">
                                                                <div class="name">
                                                        ...
                                                        <li class="product-item gap14">
                                                            <div class="image no-bg">
                                                                <img src="{{ asset('admin_assets/images/products/23.png') }}" alt="">
                                                            </div>
                                                            <div class="flex items-center justify-between gap20 flex-grow">
                                                                <div class="name">
                                                                    <a href="product-list.html" class="body-text">Mega
                        ...
                        <div class="main-content">
                         ...
                         @yield('content')
                            ...
                            <div class="bottom-page">
                                <div class="body-text">Copyright © 2025 MD TOMAS UDDIN</div>
                            </div>
                        </div>
