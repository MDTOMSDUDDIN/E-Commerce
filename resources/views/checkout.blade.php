                    ...
                    <div class="col-md-12">
                        <div class="my-account__address-list">
                            <div class="my-account__address-list-item">
                                <div class="my-account__address-list-item_detail">
                                    <p>{{ $address->name }}</p>
                                    <p>{{ $address->address }}</p>
          ...
          <div class="checkout__totals-wrapper">
            <div class="sticky-content">
              ...
              <div class="checkout__payment-methods">
                ...
                <div class="form-check">
                  <input class="form-check-input form-check-input_fill" type="radio" name="mode" value="bkash" id="mode4">
                ...
                <div class="form-check">
                  <input class="form-check-input form-check-input_fill" type="radio" name="mode" value="nogad" id="mode5">
