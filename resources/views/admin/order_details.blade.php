    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <i class="icon-chevron-right">Oder Details</i>
                </li>
                <li>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($transaction->status=='approved')
                                <span class="bade bg-success">Approved</span>
                            @elseif($transaction->status=='declinded')
                                <span class="bade bg-danger">Declinded</span>
                            @elseif($transaction->status=='refounded')
                                <span class="bade bg-secandary">Refounded</span>
                            @else
